...
export class MyProjectsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.projects = [
      ...
      {name:'Minesweeper',link:'https://github.com/NativMaatuk/Minesweeper',intro:'need to add',image:'Minesweeperimg01.png'},
      ...
      {name:'Simon Says',link:'https://github.com/NativMaatuk/Simon-Says',intro:'Memory Game for Android',image:'Minesweeperimg01.png'}  
    ];
  }
